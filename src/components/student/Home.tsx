      ...
      <header className="bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 sticky top-0 z-30 shadow-sm">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-0">
            <a
              href="#admin"
              className="btn-ghost flex items-center gap-1.5 text-xs font-semibold text-teal-600 dark:text-teal-400 border border-teal-500/30 px-3 py-1.5 rounded-lg 0 dark:hover:bg-teal-950/40"
              title="لوحة الإدارة"
            >
