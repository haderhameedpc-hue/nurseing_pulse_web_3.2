...
>
  <Send className="w-5 h-5" />
            ...
            <button onClick={onLogout} className="btn-ghost justify-center p-2 hover:text-sky-200 dark:hover:text-sky-400 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors" title="تسجيل الخروج">
